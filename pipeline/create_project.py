...
if __name__ == '__main__':
    ...
    parser.add_argument(help='Path to file with names of annotations on each line', dest='annotation_file')
    ...
    response = requests.post(config.CLOUD_FN_URL + "initialize_project", headers=headers, json=request_json)
    print(response.text)