...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Create a role and assign to users\' emails')
    ...
    response = requests.post(config.CLOUD_FN_URL + "new_role", headers=headers, json=request_json)
    print(response.text)